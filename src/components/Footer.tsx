    ...
    <footer className="bg-primary text-secondary">
      <div>
        <div className="flex divide-x divide-accent">
          {/* Footer Menu */}
          <div className="flex w-1/2 p-16 justify-between">
            {/* Pages */}
            <div className="flex flex-col gap-y-6">
              <div className="border-l-4 border-accent pl-4 text-accent uppercase font-mona font-semibold">Pages</div>
              <nav className="flex flex-col gap-y-4 text-base uppercase font-mona font-semibold">
            ...
            {/* Rooms */}
            <div className="flex flex-col gap-y-6">
              <div className="border-l-4 border-accent pl-4 text-accent uppercase font-mona font-semibold">Rooms</div>
              <nav className="flex flex-col gap-y-4 text-base uppercase font-mona font-semibold">
          ...
          <div className="flex flex-col gap-y-8">
            ...
            <div className="text-base uppercase font-mona font-semibold text-accent">Sign Up For Alerts, News & insights</div>
            <input type="text" placeholder="Email" className="w-full pl-4 pb-2 bg-transparent border-b-[1.5px] border-secondary text-secondary  placeholder:text-secondary/50 placeholder:text-base placeholder:uppercase placeholder:font-mona placeholder:font-semibold" />
            <button className="bg-secondary text-accent text-base px-6 py-3  uppercase font-mona font-semibold">Subscribe Now</button>
            </div>
            {/* End of Newsletter */}
            ...
            <div className="text-secondary text-base uppercase font-mona font-semibold pl-4">Yennekal Village, Kukke Subramanya,<br></br> Kadaba Taluk, Karnataka – 574238</div>
            </div>
            {/* End of Address */}
